...
.method public run()V
    ...
    .line 274
    iget-object v4, p0, Lcom/android/settings/SoundSettings$2;->this$0:Lcom/android/settings/SoundSettings;

    # getter for: Lcom/android/settings/SoundSettings;->mPhoneRingtonePreferences:Ljava/util/ArrayList;
    invoke-static {v4}, Lcom/android/settings/SoundSettings;->access$500(Lcom/android/settings/SoundSettings;)Ljava/util/ArrayList;
    ...
    invoke-static {v4}, Lcom/android/settings/SoundSettings;->access$600(Lcom/android/settings/SoundSettings;)Landroid/content/Context;
    ...
    invoke-static {v4, v6, v5}, Lcom/android/settings/SoundSettings;->access$700(Landroid/content/Context;II)Ljava/lang/CharSequence;
    ...
    invoke-static {v4}, Lcom/android/settings/SoundSettings;->access$400(Lcom/android/settings/SoundSettings;)Lcom/android/settings/SoundSettings$H;
    ...
    invoke-static {v4}, Lcom/android/settings/SoundSettings;->access$800(Lcom/android/settings/SoundSettings;)Landroid/preference/Preference;
    ...
    # invokes: Lcom/android/settings/SoundSettings;->updateRingtoneName(Landroid/content/Context;II)Ljava/lang/CharSequence;
    invoke-static {v4, v7, v5}, Lcom/android/settings/SoundSettings;->access$700(Landroid/content/Context;II)Ljava/lang/CharSequence;
