...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/settings/deviceinfo/UsageBarPreference$RefreshAnimationView;
    }
.end annotation
...
.field private mRescanMedia:Lcom/android/settings/deviceinfo/UsageBarPreference$RefreshAnimationView;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    .line 493
    iput-object v1, p0, Lcom/android/settings/deviceinfo/UsageBarPreference;->mRescanMedia:Lcom/android/settings/deviceinfo/UsageBarPreference$RefreshAnimationView;
    ...
    .line 497
    iput-boolean v0, p0, Lcom/android/settings/deviceinfo/UsageBarPreference;->mRescanMediaStarted:Z

    .line 498
    iput-boolean v0, p0, Lcom/android/settings/deviceinfo/UsageBarPreference;->mIsOnMeasure:Z
...
.method static synthetic access$1700(Lcom/android/settings/deviceinfo/UsageBarPreference;)Lcom/android/settings/deviceinfo/UsageBarPreference$OnRequestMediaRescanListener;
    .locals 1
    .param p0, "x0"    # Lcom/android/settings/deviceinfo/UsageBarPreference;
...
.method static synthetic access$1802(Lcom/android/settings/deviceinfo/UsageBarPreference;Z)Z
    .locals 0
    .param p0, "x0"    # Lcom/android/settings/deviceinfo/UsageBarPreference;
    .param p1, "x1"    # Z
    ...
    .prologue
    .line 54
    iput-boolean p1, p0, Lcom/android/settings/deviceinfo/UsageBarPreference;->mRescanMediaStarted:Z

    return p1
.end method

.method static synthetic access$1900(Lcom/android/settings/deviceinfo/UsageBarPreference;)Lcom/android/settings/deviceinfo/UsageBarPreference$RefreshAnimationView;
    .locals 1
    .param p0, "x0"    # Lcom/android/settings/deviceinfo/UsageBarPreference;

    .prologue
    .line 54
    iget-object v0, p0, Lcom/android/settings/deviceinfo/UsageBarPreference;->mRescanMedia:Lcom/android/settings/deviceinfo/UsageBarPreference$RefreshAnimationView;

    return-object v0
.end method

.method static synthetic access$2000(Lcom/android/settings/deviceinfo/UsageBarPreference;)Landroid/os/Handler;
    .locals 1
    .param p0, "x0"    # Lcom/android/settings/deviceinfo/UsageBarPreference;
...
.method protected notifyScanCompleted()V
    ...
    .line 553
    iget-object v1, p0, Lcom/android/settings/deviceinfo/UsageBarPreference;->mRescanMedia:Lcom/android/settings/deviceinfo/UsageBarPreference$RefreshAnimationView;
    ...
    invoke-virtual {v1, v3}, Lcom/android/settings/deviceinfo/UsageBarPreference$RefreshAnimationView;->setEnabled(Z)V

    .line 555
    iget-object v1, p0, Lcom/android/settings/deviceinfo/UsageBarPreference;->mRescanMedia:Lcom/android/settings/deviceinfo/UsageBarPreference$RefreshAnimationView;

    iget-boolean v2, p0, Lcom/android/settings/deviceinfo/UsageBarPreference;->mAllowMediaScan:Z

    if-eqz v2, :cond_1

    :goto_0
    invoke-virtual {v1, v0}, Lcom/android/settings/deviceinfo/UsageBarPreference$RefreshAnimationView;->setVisibility(I)V

    .line 556
    iget-boolean v0, p0, Lcom/android/settings/deviceinfo/UsageBarPreference;->mRescanMediaStarted:Z
    ...
    invoke-virtual {v0}, Lcom/android/settings/deviceinfo/UsageBarPreference$RefreshAnimationView;->stopProgress()V

    .line 558
    iput-boolean v3, p0, Lcom/android/settings/deviceinfo/UsageBarPreference;->mRescanMediaStarted:Z
    ...
    invoke-virtual {v0}, Lcom/android/settings/deviceinfo/UsageBarPreference$RefreshAnimationView;->reset()V
...
.method protected onBindView(Landroid/view/View;)V
    ...
    invoke-virtual {v0, v2}, Lcom/android/settings/deviceinfo/PercentageBarChart;->setEntries(Ljava/util/Collection;)V
    ...
    check-cast v0, Lcom/android/settings/deviceinfo/UsageBarPreference$RefreshAnimationView;

    iput-object v0, p0, Lcom/android/settings/deviceinfo/UsageBarPreference;->mRescanMedia:Lcom/android/settings/deviceinfo/UsageBarPreference$RefreshAnimationView;

    .line 573
    iget-object v2, p0, Lcom/android/settings/deviceinfo/UsageBarPreference;->mRescanMedia:Lcom/android/settings/deviceinfo/UsageBarPreference$RefreshAnimationView;

    iget-boolean v0, p0, Lcom/android/settings/deviceinfo/UsageBarPreference;->mIsOnMeasure:Z
    ...
    :goto_0
    invoke-virtual {v2, v0}, Lcom/android/settings/deviceinfo/UsageBarPreference$RefreshAnimationView;->setEnabled(Z)V
    ...
    :goto_1
    invoke-virtual {v0, v1}, Lcom/android/settings/deviceinfo/UsageBarPreference$RefreshAnimationView;->setVisibility(I)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/settings/deviceinfo/UsageBarPreference$RefreshAnimationView;->setOnClickListener(Landroid/view/View$OnClickListener;)V
...
.method protected setOnRequestMediaRescanListener(Lcom/android/settings/deviceinfo/UsageBarPreference$OnRequestMediaRescanListener;)V
    .locals 0
    .param p1, "listener"    # Lcom/android/settings/deviceinfo/UsageBarPreference$OnRequestMediaRescanListener;
